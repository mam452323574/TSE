export const IT_TRANSLATIONS = {
  ...
  "scan_limits": {
    ...
    "upgrade_unlimited_subtitle": "Passa a Premium per scansioni illimitate"
  },
  "home": {
  ...
  "coach": {
    ...
    "title": "Chiedi una guida wellness mirata",
    "body": "Scegli un prompt e riutilizzeremo i tuoi scan recenti per generare una risposta strutturata e in cache. Coach offre solo indicazioni wellness, mai una diagnosi.",
    "persona_section_title": "Scegli la personalita del Coach",
    ...
    "prompt_section_title": "Scegli un prompt Coach",
    ...
    "prompts": {
      "latest_scan": {
        "title": "Ultimo scan",
        "subtitle": "Trasforma il risultato piu recente in un mini piano d'azione."
      },
      "weekly_plan": {
      ...
      "nutrition_focus": {
        ...
        "subtitle": "Ricevi un consiglio sul cibo dal tuo ultimo scan nutrizione."
      },
      "body_focus": {
        "title": "Focus corpo",
  ...
  "entry_offer": {
    "placeholder_eyebrow": "Fase 1",
    "placeholder_title": "L'offerta iniziale e pronta da collegare",
    "placeholder_body": "Questo flusso modale resta dietro un flag finche contratto RevenueCat e logica di eleggibilita non saranno definiti.",
    "placeholder_card_title": "Fondazione pronta",
    "placeholder_card_body": "Lo shell di navigazione e compile-safe e resta invisibile finche il flag e disattivato."
  },
  ...
  "premium": {
    ...
    "subscription_page": {
      "hero_title": "Sblocca tutto il tuo potenziale di salute",
      "hero_subtitle": "Scegli il piano giusto per te",
      "free_title": "Gratis",
      "free_price": "0 €",
      ...
      "prem_feat_super": "1 Super Scan al giorno",
  ...
  "scanner": {
    ...
    "camera_permission_detail": "Le foto di viso, corpo e cibo vengono usate per eseguire l'analisi salute tramite IA nell'app.",
  ...
  "onboarding": {
    ...
    "slide_1_title": "La bilancia mente. Lo specchio improvvisa.",
    "slide_1_subtitle": "Senza scan, leggi un'impressione. Non un segnale.",
    "slide_2_title": "Lo scan legge. I dati decidono.",
    "slide_2_subtitle": "Viso, corpo, nutrizione. Lettura netta. Zero approssimazioni.",
    "slide_3_title": "Controlla la traiettoria.",
    "slide_3_subtitle": "Misura ogni variazione. Smetti di guidare alla cieca.",
